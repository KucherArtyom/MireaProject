...
import ru.mirea.kucheras.mireaproject.databinding.FragmentMicrophoneBinding;
...
public class MicrophoneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentMicrophoneBinding.inflate(getLayoutInflater());
        View view = binding.getRoot();
        recordButton = binding.button3;
        playButton = binding.button4;
