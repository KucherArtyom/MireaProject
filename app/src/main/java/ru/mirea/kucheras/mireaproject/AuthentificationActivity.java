...
import ru.mirea.kucheras.mireaproject.databinding.ActivityAuthentificationBinding;
...
// Re-enable button
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(AuthentificationActivity.this, "Failed to send verification email.",
